...
_This document was fact-checked against the official documentation. Claims are attributed to those sources; anything not stated there is called out in [Not in official documentation](#not-in-official-documentation-but-known-to-be-true)._
