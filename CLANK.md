...
- **Hands-off config trees.** Do not change files under `.claude/`, `.claude-plugin/`, `.cursor/`, or `.superagent/` unless the user explicitly requests edits to those paths in the current prompt.
