...
- Keep short critical info in CLANK.md; use [plugin README](../README.md) (or docs) for expanded guidance
...
- Keep things DRY — one canonical source per concern; link from README/CLANK.md/other rules instead of restating
...
Base new plugins on this driver plugin layout and this convention. See [plugin README](../README.md). See also [clankgsters-sync-file-naming.md](./clankgsters-sync-file-naming.md).
