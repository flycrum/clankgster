# Reference hub: context pathway triage

Use this hub for pathway selection and dispatch conventions.
...
3. [common_internal-in-session-vs-mcp-policy.md](../../references/common_internal-in-session-vs-mcp-policy.md)
