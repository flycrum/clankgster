...
const ROUTES = [
  ...
  {
    routeId: 'plugins.create',
    toolName: 'PluginsCreate',
    targetSkillId: 'plugins-create-context',
    pathway: 'plugins',
    action: 'create',
    description: 'Route plugin create workflows',
  ...
  {
    routeId: 'plugins.audit.contentQuality',
    toolName: 'PluginsAuditContentQuality',
    targetSkillId: 'plugins-audit-content-quality',
    pathway: 'plugins',
    action: 'audit',
    description: 'Route plugin content quality audit',
    inputSchema: genericRouteInputSchema(),
  },
  {
    routeId: 'plugins.audit.externalLinks',
    toolName: 'PluginsAuditExternalLinks',
    targetSkillId: 'plugins-audit-external-links',
    pathway: 'plugins',
    action: 'audit',
    description: 'Route plugin external links audit',
    inputSchema: genericRouteInputSchema(),
  },
  {
    routeId: 'plugins.audit.factCheck',
    toolName: 'PluginsAuditFactCheck',
    targetSkillId: 'plugins-audit-fact-check',
    pathway: 'plugins',
    action: 'audit',
    description: 'Route plugin fact-check audit',
    inputSchema: genericRouteInputSchema(),
  },
  {
    routeId: 'plugins.audit.internalLinks',
    toolName: 'PluginsAuditInternalLinks',
    targetSkillId: 'plugins-audit-internal-links',
    pathway: 'plugins',
    action: 'audit',
    description: 'Route plugin internal links audit',
    inputSchema: genericRouteInputSchema(),
  },
  {
    routeId: 'plugins.audit.sourceFreshness',
    toolName: 'PluginsAuditSourceFreshness',
    targetSkillId: 'plugins-audit-source-freshness',
    pathway: 'plugins',
    action: 'audit',
    description: 'Route plugin source freshness audit',
    inputSchema: genericRouteInputSchema(),
  },
  {
    routeId: 'plugins.audit.comparisonMatrix',
    toolName: 'PluginsAuditComparisonMatrix',
    targetSkillId: 'plugins-audit-comparison-matrix',
    pathway: 'plugins',
    action: 'audit',
    description: 'Route plugin comparison matrix audit',
    inputSchema: genericRouteInputSchema(),
  },
  {
    routeId: 'plugins.audit.structure',
    toolName: 'PluginsAuditStructure',
    targetSkillId: 'plugins-audit-structure',
    pathway: 'plugins',
    action: 'audit',
    description: 'Route plugin structure audit',
    inputSchema: genericRouteInputSchema(),
  },
  {
    routeId: 'skills.create',
    toolName: 'SkillsCreate',
    targetSkillId: 'skills-create-context',
    pathway: 'skills',
    action: 'create',
    description: 'Route standalone skill create workflows',
    inputSchema: genericRouteInputSchema(),
  },
  {
  ...
  {
    routeId: 'skills.audit.contentQuality',
    toolName: 'SkillsAuditContentQuality',
    targetSkillId: 'skills-audit-content-quality',
    pathway: 'skills',
    action: 'audit',
    description: 'Route standalone skill content quality audit',
    inputSchema: genericRouteInputSchema(),
  },
  {
    routeId: 'skills.audit.externalLinks',
    toolName: 'SkillsAuditExternalLinks',
    targetSkillId: 'skills-audit-external-links',
    pathway: 'skills',
    action: 'audit',
    description: 'Route standalone skill external links audit',
    inputSchema: genericRouteInputSchema(),
  },
  {
    routeId: 'skills.audit.factCheck',
    toolName: 'SkillsAuditFactCheck',
    targetSkillId: 'skills-audit-fact-check',
    pathway: 'skills',
    action: 'audit',
    description: 'Route standalone skill fact-check audit',
    inputSchema: genericRouteInputSchema(),
  },
  {
    routeId: 'skills.audit.internalLinks',
    toolName: 'SkillsAuditInternalLinks',
    targetSkillId: 'skills-audit-internal-links',
    pathway: 'skills',
    action: 'audit',
    description: 'Route standalone skill internal links audit',
    inputSchema: genericRouteInputSchema(),
  },
  {
    routeId: 'skills.audit.sourceFreshness',
    toolName: 'SkillsAuditSourceFreshness',
    targetSkillId: 'skills-audit-source-freshness',
    pathway: 'skills',
    action: 'audit',
    description: 'Route standalone skill source freshness audit',
    inputSchema: genericRouteInputSchema(),
  },
  {
    routeId: 'clankmd.create',
    toolName: 'ClankMdCreate',
    targetSkillId: 'clankmd-create-context',
    pathway: 'clankmd',
    action: 'create',
    description: 'Route CLANK.md create workflows',
    inputSchema: genericRouteInputSchema(),
  },
  {
  ...
  {
    routeId: 'clankmd.audit.contentQuality',
    toolName: 'ClankMdAuditContentQuality',
    targetSkillId: 'clankmd-audit-content-quality',
    pathway: 'clankmd',
    action: 'audit',
    description: 'Route CLANK.md content quality audit',
    inputSchema: genericRouteInputSchema(),
  },
  {
    routeId: 'clankmd.audit.externalLinks',
    toolName: 'ClankMdAuditExternalLinks',
    targetSkillId: 'clankmd-audit-external-links',
    pathway: 'clankmd',
    action: 'audit',
    description: 'Route CLANK.md external links audit',
    inputSchema: genericRouteInputSchema(),
  },
  {
    routeId: 'clankmd.audit.factCheck',
    toolName: 'ClankMdAuditFactCheck',
    targetSkillId: 'clankmd-audit-fact-check',
    pathway: 'clankmd',
    action: 'audit',
    description: 'Route CLANK.md fact-check audit',
    inputSchema: genericRouteInputSchema(),
  },
  {
    routeId: 'clankmd.audit.internalLinks',
    toolName: 'ClankMdAuditInternalLinks',
    targetSkillId: 'clankmd-audit-internal-links',
    pathway: 'clankmd',
    action: 'audit',
    description: 'Route CLANK.md internal links audit',
    inputSchema: genericRouteInputSchema(),
  },
  {
    routeId: 'clankmd.audit.sourceFreshness',
    toolName: 'ClankMdAuditSourceFreshness',
    targetSkillId: 'clankmd-audit-source-freshness',
    pathway: 'clankmd',
    action: 'audit',
    description: 'Route CLANK.md source freshness audit',
    inputSchema: genericRouteInputSchema(),
  },
];
