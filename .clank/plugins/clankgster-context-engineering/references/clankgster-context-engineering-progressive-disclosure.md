...
- See [clankgster-context-engineering-writing-descriptions.md](clankgster-context-engineering-writing-descriptions.md)
...
**Fix:** Link to the reference with a brief summary of what it covers. "For prompt technique guidelines, see [prompt-techniques.md](../../references/clankgster-context-engineering-prompt-techniques.md)."
