...
For the full decision tree with branching logic and edge cases, see [content-type-decision-tree.md](../docs/clankgster-context-engineering-content-type-decision-tree.md).

For an exhaustive feature comparison of all content types, see [content-type-comparison-matrix.md](../docs/clankgster-context-engineering-content-type-comparison-matrix.md).
...
[prompt-techniques.md](../references/clankgster-context-engineering-prompt-techniques.md).
```
...
```md
clankgster-context-engineering-writing-rules.md     ← good
