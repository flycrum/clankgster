...
- `clankgster-context-engineering-writing-rules.md`
...
```markdown
For detailed prompt engineering techniques, see [prompt-techniques.md](../references/clankgster-context-engineering-prompt-techniques.md).
```

This keeps rules lean and focused while making detail available on demand. See [progressive-disclosure.md](../references/clankgster-context-engineering-progressive-disclosure.md) for how agents load linked content.
